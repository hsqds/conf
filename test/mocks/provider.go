...
// Source: github.com/hate-squids/config-provider/internal/provider (interfaces: Source,SourcesStorage,Config,ConfigsStorage,Loader)
...
import (
	...
	provider "github.com/hate-squids/config-provider/internal/provider"
)
...
func (m *MockSourcesStorage) Append(arg0 provider.Source) error {
	m.ctrl.T.Helper()
...
func (m *MockSourcesStorage) Get(arg0 string) (provider.Source, error) {
	m.ctrl.T.Helper()
...
func (m *MockConfigStorage) Set(arg0 string, arg1 provider.Config) error {
	m.ctrl.T.Helper()
