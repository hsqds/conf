...
// Source: github.com/hate-squids/config-provider/provider (interfaces: Source,SourcesStorage,ConfigsStorage,Loader)
...
func (m *MockSourcesStorage) List() []provider.Source {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "List")
	ret0, _ := ret[0].([]provider.Source)
	return ret0
}
...
func (m *MockSourcesStorage) Set(arg0 string, arg1 provider.Source) error {
	m.ctrl.T.Helper()
...
func (mr *MockSourcesStorageMockRecorder) Set(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockSourcesStorage)(nil).Set), arg0, arg1)
}
...
func (m *MockConfigStorage) Get(arg0 string) (provider.Config, error) {
	m.ctrl.T.Helper()
...
func (m *MockConfigStorage) Update(arg0 string, arg1 provider.Config) error {
	m.ctrl.T.Helper()
...
func (mr *MockConfigStorageMockRecorder) Update(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockConfigStorage)(nil).Update), arg0, arg1)
}
...
// Load mocks base method.
func (m *MockLoader) Load(arg0 context.Context, arg1 []provider.Source, arg2 []string) []provider.LoadResult {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Load", arg0, arg1, arg2)
	ret0, _ := ret[0].([]provider.LoadResult)
	return ret0
}
